//==========================================================================
// ViGraph dataflow module: trigger/selector/test-selector.cc
//
...
public:
  SelectorTest()
  {
    loader.load("./vg-module-trigger-selector.so");
  }
};
...
{
  auto& selector = add("trigger/selector").set("inputs", Integer{3});
  setup(selector);
